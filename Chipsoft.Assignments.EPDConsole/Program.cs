...
namespace Chipsoft.Assignments.EPDConsole
{
    public class Program
    {
        ...
        private static void RegisterServices()
        {
            ...
            var applicationAssembly = typeof(Application.Appointments.Queries.GetAppointmentsListQuery).Assembly;
        ...
        private static Task DisplayAppointments(System.Collections.Generic.List<Application.Appointments.Dtos.AppointmentDto> appointments)
        {
            Console.WriteLine("\n--- Overzicht afspraken ---");
            if (!appointments.Any())
            {
